# the instructions say to remove_dups, but I think a better name is make unique
# you're supposed to take a string and then add letters to a new string, only if they are not already used.
